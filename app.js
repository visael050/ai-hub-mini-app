...
document.getElementById("share").onclick=()=>{const u=encodeURIComponent("https://t.me/YOUR_BOT_USERNAME?startapp=share");const t=encodeURIComponent("Попробуй AI HUB — нейросети для работы, учёбы и творчества 🤖");const x="https://t.me/share/url?url="+u+"&text="+t;if(TG?.openTelegramLink)TG.openTelegramLink(x);else window.open(x,"_blank")};